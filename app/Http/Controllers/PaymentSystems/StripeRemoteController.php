...
class StripeRemoteController extends Controller
{
    #[
        Group('payment'),
    ...
    public function deposit(Request $request, StripeRemotePaymentSystem $stripePS): ApiResponse
    {
    ...
    public function hook(Request $request, StripeRemotePaymentSystem $stripePS)
    {
