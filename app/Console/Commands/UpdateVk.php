...
class UpdateVk extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'smm:update_vk_validators';
     ...
     * @var string
     */
    protected $description = 'Reconfigure VK validators 6 december 2021';
    ...
    public function handle()
    {
        ...
        echo "New VK validators great again!\n\n";
